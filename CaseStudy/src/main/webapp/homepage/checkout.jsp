            ...
            <div class="row">
                <div class="col-12 col-lg-8">
                    <div class="checkout_details_area mt-50 clearfix">
                        ...
                        <form  action="/Customers?action=createCustomer" method="post">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <input type="text" class="form-control" name="name" id="first_name" value="" placeholder="Full Name" required>
                                </div>
                                <div class="col-12 mb-3">
                            ...
                            <div class="cart-btn mt-100">
                                ...
                                <button type="submit" class="btn amado-btn w-100">Payment</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="cart-summary">
                        ...
                        <div class="payment-method">
                            ...
                            <div class="custom-control custom-checkbox mr-sm-2">
                                ...
                                <label class="custom-control-label" for="paypal">Paypal <img class="ml-15" src="<%=request.getContextPath()%>WepPage/img/core-img/paypal.png" alt=""></label>
                            </div>
                        </div>
